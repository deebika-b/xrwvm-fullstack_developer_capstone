...
// ✅ Corrected: Fetch all dealerships
...
// ✅ Corrected: Fetch dealerships by state
...
app.post('/insert_review', express.raw({ type: '*/*' }), async (req, res) => {
  try {
    ...
    const new_id = lastReview ? lastReview.id + 1 : 1; // Handle case where DB is empty
